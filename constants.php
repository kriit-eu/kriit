...
const ACTIVITY_TOGGLE_CRITERION = 18;
const ACTIVITY_ADD_GRADE = 19;
const ACTIVITY_UPDATE_GRADE = 20;
const ACTIVITY_DELETE_CRITERION = 21;
const ACTIVITY_ADD_CRITERION = 22;
const IS_ID = 1;
const IS_INT = 2;
const IS_0OR1 = 3;
const IS_ARRAY = 4;
