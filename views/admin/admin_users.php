        ...
        <table class="table table-striped table-bordered table-searchable">
            ...
            <tbody>
                <?php foreach ($users as $user): ?>
                    <tr<?= !empty($user['userDeleted']) ? ' class="user-deleted"' : '' ?>>
                        ...
                        <td data-searchable="false">
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="#" class="text-warning edit-user" data-id="<?= $user['userId'] ?>"
                                    ...
                                    data-useremail="<?= $user['userEmail'] ?>" data-userdeleted="<?= $user['userDeleted'] ?? 0 ?>"
                                    data-context="edit">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addUserForm" method="post">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" name="userDeleted" class="form-check-input" id="userDeleted">
                        <label class="form-check-label" for="userDeleted">Kustutatud</label>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('.edit-user').on('click', function(e) {
            ...
            $('#userDeleted').prop('checked', !!userDeleted);
        ...
        // Delete action moved into edit modal via the userDeleted checkbox
...
<style>
    ...
    /* Make deleted users visibly subdued */
    tr.user-deleted {
